...
check_gbm_gps_robustness <- function(W, data, treatment_var = "VTEPROPHYLAXISHRS") {
  ...
  cat("\n🏆 Part 5: Overall Robustness Assessment\n")
  cat("=======================================\n")
...
if (exists("W") || exists("W_tuned")) {
  ...
  cat("❌ No GBM model found. Please run the GBM weighting section first.\n")
}
```
...
if (sum(valid_boots) < 50) {
  cat("❌ Insufficient valid bootstrap samples for reliable inference\n")
} else {
